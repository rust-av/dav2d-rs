...
mod build {
    ...
    const REPO: &str = "https://code.videolan.org/videolan/dav2d.git";
    const TAG: &str = "0.1.0";
    ...
    pub fn build_from_src(
        ...
        let source = PathBuf::from(env::var("OUT_DIR").unwrap()).join("dav2d");
...
fn main() {
    ...
    system_deps::Config::new()
        .add_build_internal("dav2d", build::build_from_src)
        .probe()
        .unwrap();
}
